...
namespace VisorEmpresa.Data
{
    ...
    /// autenticación registrados en %AppData%\SistemaGestion\conexion.dat (mismo
    /// archivo que usa SistemaGestion — ambas apps comparten el mismo broker
    /// activo). Ya no guarda credenciales de SQL Server (la URL del broker no
    /// es secreta; el cifrado queda solo por prolijidad).
    /// </summary>
