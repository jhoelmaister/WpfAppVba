...
namespace VisorEmpresa
{
    ...
    /// (IDENTIFICACIÓN/CLASIFICACIÓN/DETALLES/OBSERVACIONES), ahora EDITABLE
    /// (Nuevo/Insertar/Editar, igual que la app principal). Selectores de
    /// Familia/Industria/Categoría abren las copias propias del visor
    /// (VisorEmpresa.FamiliasGeneral/IndustriasGeneral/CategoriasGeneral).
    /// Sin botón "Ver Movimientos": depende de MovimientosGeneral, que usa
    /// AppState.SucursalActiva/AperturaActiva — nunca pobladas en VisorEmpresa
    /// (mismo problema ya documentado con StockCalculator) — descartado a
    /// propósito en vez de portarlo mal.
    /// </summary>
