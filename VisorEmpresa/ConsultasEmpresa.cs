...
namespace VisorEmpresa
{
    ...
    public static class ConsultasEmpresa
    {
        ...
        public static void ConectarCacheFacturas(string empresa, int anio)
        {
            ...
            // Cobros/pagos: FacturasDetalle los lee de Sql.TransaccionesFObj, así que
            // la caché del visor también los tiene que traer (mismo criterio que
            // AppLoader.ConectarDocumentos en la app principal).
