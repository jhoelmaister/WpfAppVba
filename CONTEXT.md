...
- Los detalles de documentos ya NO borran todas las líneas y las recrean al guardar. Ahora hacen un **guardado diferencial**:
  ...
  - El **índice** de cada línea visible se asigna por su **posición en la grilla** (1..N): si se inserta una línea en la posición 1, toma índice 1 y las demás se corren. Los índices entre filas activas (normal) no se duplican; las filas eliminadas conservan su índice pero se ignoran al recargar.
