...
namespace SistemaGestion
{
    ...
    /// Persistencia 100% local: %LOCALAPPDATA%\SistemaGestion\theme.txt (último tema
    ...
    public static class ThemeManager
    {
        ...
        /// <summary>Persiste el último tema en %LOCALAPPDATA%\SistemaGestion\theme.txt</summary>
